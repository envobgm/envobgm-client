...
const BrowserErrorLog =
  /* #__PURE__ */
  (function() {
    function BrowserErrorLog() {
      _classCallCheck(this, BrowserErrorLog);

      _electronLog.default.transports.file.level = 'info';
      _electronLog.default.transports.file.fileName = 'browserErrorLog.log';
      this._logger = _electronLog.default;
    }

    _createClass(BrowserErrorLog, [
      {
        key: 'debug',
...
exports.default = BrowserErrorLog;
